...
class TeachersPage(ctk.CTk):
    def __init__(self):
        ...
        self.title("Teachers Management System")
    ...
    def create_main_content(self):
        ...
        # Top Bar Container Setup
        top_bar = ctk.CTkFrame(main_container, height=70, corner_radius=0, fg_color=self.WHITE)
        top_bar.grid(row=0, column=0, sticky="ew")
        top_bar.grid_columnconfigure(0, weight=1)
        top_bar.grid_propagate(False)
        
        page_title = ctk.CTkLabel(top_bar, text="Teachers Management", font=ctk.CTkFont(size=20, weight="bold"), text_color=self.TEXT_DARK)
